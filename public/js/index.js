var Calendar = function (t) {
    this.divId = t.RenderID ? t.RenderID : '[data-render="calendar"]', this.DaysOfWeek = t.DaysOfWeek ? t.DaysOfWeek : ["Dom", "Lun", "Mar", "Mie", "Jue", "Vie", "Sab"], this.Months = t.Months ? t.Months : ["Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dic"];
    var e = new Date;
...
const openClose = document.querySelector('.edit')

toggleBtn.addEventListener('click', (e) => { 
    e.preventDefault();
    if (openClose.classList.contains('activo')) {
        openClose.classList.remove('activo')
    } else {
        openClose.classList.add('activo')
    }
})